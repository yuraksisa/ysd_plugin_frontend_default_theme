...
module YsdPluginFrontendDefaultTheme
  ...
  class FrontendDefaultThemeExtension < Plugins::ViewListener
    ...
    def install(context={})
      ...
      SystemConfiguration::Variable.first_or_create({:name => 'frontend.skin.default.slider1_img_bg'},
                                                    {:value => '.',
                                                     :description => 'Slider1 background image path',
                                                     :module => :frontend_rentit_theme})


      SystemConfiguration::Variable.first_or_create({:name => 'frontend.skin.default.css.header_background'},
                                                    {:value => '#fbfbfb',
                                                     :description => 'Slider1 background image path',
                                                     :module => :frontend_rentit_theme})
